...
> **`.claude/skills/slide/assets/design-systems/jangpm/`** 폴더 전체입니다 (`brand-spec.md` + `colors_and_type.css` + `_pptx-slide.css` + `pptx-boilerplate/` + `DESIGN.md` + `theme.json`).
...
패턴 HTML 원본은 `.claude/skills/slide/assets/design-systems/jangpm/pptx-boilerplate/`에 있습니다.
...
│       │
│       │   └── assets/design-systems/                ← 디자인 시스템 자산 + 헤리티지
│       │       ├── jangpm/                           ← 활성 프리셋 (SSOT)
│       │       │   ├── DESIGN.md                     ← 활성 시각 어휘 사양
...
│       │
│       └── codex-image/                              ← Codex OAuth 기반 이미지 생성
│           └── SKILL.md
│
...
```
.claude/skills/slide/assets/design-systems/<preset>/
...
.claude/skills/slide/assets/design-systems/jangpm/                      ← 활성 프리셋 SSOT
.claude/skills/slide/assets/design-systems/jangpm/pptx-boilerplate/     ← 37 패턴 HTML
.claude/skills/theme-init/SKILL.md                                      ← 새 프리셋 생성기
.claude/skills/theme-init/scripts/init_theme.py                         ← /theme-init 오케스트레이터
.claude/skills/codex-image/SKILL.md                                     ← Codex OAuth 이미지 생성
output/                                                                 ← 빌드 결과물 (주제별)
```
