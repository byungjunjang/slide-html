...
#
# 사용:
#   bash .codex/skills/slide/scripts/init-project.sh <project-name> [<design-system>]
#
# 자동 생성:
...
if [ -f "$DS_SOURCE/_pptx-slide.css" ]; then
  ...
  echo "    python3 $REPO_ROOT/.codex/skills/theme-init/scripts/init_theme.py \\"
...
- 더 보려면: \`.codex/skills/slide/references/error-patterns.md\`
EOF
